...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [Burada](https://discord.gg/cF5SPMvnAx) Tanıtıldı! \n\n 12 Saat Sonra Sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu Tanıtabilmek İçin Beni [Ekle](https://discord.com/oauth2/authorize?client_id=784795240896659466&scope=bot&permissions=8)')
  .setColor('GREEN')
 message.channel.send(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL())
       client.channels.cache.get('787769510647955466').send(embed)
            });
