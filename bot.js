        ...
        if (reklam.some(word => msg.content.includes(word))) {
          try {
            if (!msg.member.hasPermission("BAN_MEMBERS")) {
                  msg.delete();
                    return msg.reply('**Bu Sunucuda** `Reklam Engelle`** Aktif Reklam Yapmana İzin Vermem İzin Vermem ? !**').then(m => m.delete({timeout: 3000}));
          ...
          try {
            if (!msg.member.hasPermission("MANAGE_GUILD")) {
                  msg.delete();
                    ...
                    return msg.channel.send(`**Bu Sunucuda Küfür Yasak Dostum !**`).then(m => m.delete({timeout: 1000}))
            }              
                } catch(err) {
                  console.log(err);
                }
